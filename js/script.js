window.onload = function () {
    ...
    function showBuyGood(){
        ...
        // 전체선택 버튼 해제
        // if(buyTotalCount === chkAll.length){
    ...
    // 15. 이용후기 화면출력기능
    let REVIEW_ARR;
    let reviwTag = document.getElementById("data-review");
    function showReview(){
        let html = `
                    ...
                    <div class="review-box">
                        <a href="${item.link}">
                            <div class="review-box-desc">
                                <span class="review-box-title">${item.title}</span>
                                <span class="review-box-star"> ${item.star} </span>
                                <span class="review-box-img">
                                    <img src="../images/${item.pic}" alt="${item.title}" />
                                </span>
                            </div>
                            <p class="review-box-txt">${item.txt}</p>
